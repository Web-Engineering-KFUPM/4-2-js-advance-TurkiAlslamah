...
student.gpa = 4.1;    // ignored, out of range
console.log("GPA after invalid update: " + student.gpa);
student.gpa = 3.9;  // valid
console.log("GPA after valid update: " + student.gpa);   
